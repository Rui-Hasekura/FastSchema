...
#ifndef FSCHEMA_LITEMATIC_INTERNAL_PROPERTIES_H_
#define FSCHEMA_LITEMATIC_INTERNAL_PROPERTIES_H_
...
[[nodiscard]] ParseResult<void> ForEachProperty(
  ...
  base::ByteReader reader(properties, limits);
  reader.push_depth();
  for (;;) {
    std::string_view key;
    ...
    if (*tag_result != base::TagType::String) {
      reader.pop_depth();
...
#endif  // FSCHEMA_LITEMATIC_INTERNAL_PROPERTIES_H_